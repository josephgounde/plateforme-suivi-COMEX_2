...
/// Lit WorkflowEtapes.Ordre/Actif à chaque appel (pas de table figée) pour que le réordonnancement Admin pilote vraiment le routage, pas juste l'affichage.
internal static class WorkflowEngine
{
    ...
    /// Avance vers la prochaine étape active (historique ou perso), utilisé par Soumettre et Valider. Ne fait rien en fin de circuit.
    ...
    {
        // Priorité au code, pas au TypeEtape : ETAPE_1_INITIATION/7_ARCHIVAGE sont seedées en GENERIQUE mais restent historiques.
        // Tester TypeEtape d'abord casserait un rejet vers ETAPE_1_INITIATION (finirait sur écran générique au lieu de BROUILLON).
