// Liste fermée des pays sélectionnables comme bénéficiaire (Initiation dossier).
// Remplace la saisie libre : TransfertClassification.EstUemoa (backend) compare le texte
// exact pour ventiler les exports réglementaires UEMOA/hors UEMOA — une orthographe qui
// dérive (ex: "RCI", "Cote d Ivoire") faisait glisser silencieusement un dossier dans la
// mauvaise feuille. Les 8 libellés UEMOA ci-dessous doivent rester identiques à
// PDOE.Reporting.API/Reglementaire/TransfertClassification.cs (PaysUemoa).
import { DropdownOption } from '../../shared/components/dropdown-select/dropdown-select.component';
...
export const PAYS = [
  ...
  'Ouzbékistan', 'Pakistan', 'Palaos', 'Panama', 'Papouasie-Nouvelle-Guinée', 'Paraguay',
  ...
  'Suriname', 'Syrie', 'Tadjikistan', 'Tanzanie', 'Tchad', 'République tchèque', 'Thaïlande',
...
export const PAYS_OPTIONS: DropdownOption[] = PAYS.map(p => ({ value: p, label: p }));
